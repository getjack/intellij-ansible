...
import com.github.getjackx.intellij.plugins.ansible.lexer.NeonHighlightingLexer;
import com.github.getjackx.intellij.plugins.ansible.lexer.NeonLexer;
import org.jetbrains.annotations.NotNull;

import java.util.HashMap;
import java.util.Map;

import static com.github.getjackx.intellij.plugins.ansible.lexer.NeonTokenTypes.*;
...
public class NeonSyntaxHighlighter extends SyntaxHighlighterBase {
    ...
    public static final TokenSet sJINJA = TokenSet.create(NeonElementTypes.JINJA, NEON_LBRACE_JINJA, NEON_RBRACE_JINJA, NEON_IDENTIFIER);
